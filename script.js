...
const translations = {
  en: {
    ...
    "hero.meta": "Senior developer-in-training at MIU, finishing next spring — based in Ulaanbaatar, Mongolia.",
    "hero.ctaWork": "See my work",
    "hero.ctaContact": "Get in touch",
    "hero.photoPlaceholder": "Drop your photo in<br><code>images/profile.jpg</code>",
    "about.heading": "About",
    "about.p1": "I'm a senior at MIU in Ulaanbaatar, graduating next spring fall. Most of my work happens on the backend — auth flows, database schemas, APIs — but I build the mobile and web layers that use them too, so I can take something from a blank repo to a shipped build on my own when I need to.",
